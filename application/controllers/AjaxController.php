...
//     if(  $select == '*' or $select == 'All' )         return '';
     ...
     if(  $table == 'Persons'      )    $return = ' AND        Persons.user_roles    = "' . $select . '"';
...
private function get_comments() {
     ...
     if(  strpos( $user_roles, 'staff'  )
     or   strpos( $user_roles, 'admin'  )
     or   strpos( $user_roles, 'support'))
          $staff = 'true' ;
     else $staff = 'false';
...
private function reset() {
     ...
     $control = db_get_row( 'Controls', 'status = "active" AND control_set ="User Roles" AND control_name= "' . get_session( 'user_roles' ) . '"' );
