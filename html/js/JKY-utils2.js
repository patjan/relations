...
//        ----------------------------------------------------------------------
function JKY.get_value(name) {
//alert('JKY.get_value, name: ' + name);
     if( !$('#' + name).val())
          return '';
...
//        ----------------------------------------------------------------------
function JKY.get_text(name) {
//alert('JKY.get_text, name: ' + name);
    if(!$('#' + name).val())
        return '""';

    value = JKY.htmlEntities($('#' + name).val().trim());
//    value = $('#' + name).val().trim();
    return '"' + value + '"';
}
...
//        ----------------------------------------------------------------------
function JKY.get_file_type(full_name) {
...
//  var JC = JKY.name_space('JKY.core');
//  var JKY = JKY || {};                //  create namespace JKY
//  JKY.core = {};                      //  create object core
//  ----------------------------------------------------------------------------
function JKY.name_space(string) {
	var parent = window;
